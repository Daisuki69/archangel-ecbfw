...
const LoginScreen = ({onLogin, fastMode}) => {
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",height:"100%",padding:"24px",background:C.white,position:"relative", fontFamily: "'JekoMedium', sans-serif"}}>
      ...
      {error && (
        <div style={{position:"absolute",inset:0,background:"rgba(0,0,0,0.5)",zIndex:100,display:"flex",alignItems:"center",justifyContent:"center",padding:"24px",borderRadius:34}}>
      ...
      {/* Top Right Help Icon - Successfully converted to React format! */}
      ...
      {/* UPPER SECTION: Logo and Password (Moved to ~14vh to sit in that upper-middle sweet spot!) */}
      <div style={{display:"flex",flexDirection:"column",alignItems:"center", width: "100%", marginTop: "14vh"}}>
        ...
        <div style={{fontSize:13,color:C.med,letterSpacing:3,marginBottom:36}}>CARL CEDRIC</div>
        
        {/* Password field */}
        <div style={{width:"100%",marginBottom: showRequired ? 4 : 14}}>
          <div style={{position:"relative", height: "56px", background:C.white,borderRadius:14, border:`1.5px solid ${boxBorderColor}`,transition:"border-color 0.2s", display: "flex", flexDirection: "column", justifyContent: "center", paddingLeft: "16px"}}>
            ...
            <div style={{fontSize:10,color:labelColor,fontWeight:800,marginTop:"-6px",marginBottom:"4px",transition:"color 0.2s"}}>Password</div>
            ...
            <div style={{display: "flex", alignItems: "center", paddingRight: "50px"}}>
              <input
                ...
                style={{width: "100%",border: "none",outline: "none",fontSize: 15,fontWeight: 700,color: C.dark,background: "transparent",letterSpacing: show ? 0 : 2,caretColor: C.green,padding: 0,margin: 0}}
              />
            </div>
      ...
      <div style={{display:"flex",flexDirection:"column",alignItems:"center", width: "100%", paddingBottom: "16px"}}>
        ...
        {/* Soft Square Main Log In Button */}
...
export default function MayaApp() {
  ...
  return (
    <div style={{display:"flex",justifyContent:"center",alignItems:"center",minHeight:"100vh",background:"linear-gradient(135deg,#0a0a1a,#1f155f 50%,#071a0a)"}}>
      <GlobalStyle/>
      <div style={{width:375,height:720,background:C.white,borderRadius:40,overflow:"hidden",boxShadow:"0 40px 80px rgba(0,0,0,0.7),0 0 0 6px #1a1a1a",position:"relative",display:"flex",flexDirection:"column",transform:"scale(0.8)",transformOrigin:"center center"}}>
        {/* Notch */}
        ...
        <div style={{flex:1,overflow:"hidden",position:"relative"}}>
          ...
          {transitioning&&(
            <div style={{position:"absolute",inset:0,background:"rgba(255,255,255,0.55)",zIndex:500,display:"flex",alignItems:"center",justifyContent:"center",borderRadius:34}}>
              <div style={{width:36,height:36,border:"4px solid #e0f5ea",borderTop:`4px solid ${C.green}`,borderRadius:"50%",animation:"spin 0.7s linear infinite"}}/>
              <style>{`@keyframes spin{to{transform:rotate(360deg)}}`}</style>
            </div>
          )}
