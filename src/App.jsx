    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          marginTop: isKeyboardOpen ? "24px" : "16vh", // <--- CHANGED FROM 20vh TO 15vh
          ...
          <div style={{fontSize:30,fontWeight:800,marginBottom:4}}>+63 994 304 0344</div>
          <div style={{fontSize:25,color:C.med,letterSpacing:0, marginBottom: 36}}>CARL CEDRIC</div>
