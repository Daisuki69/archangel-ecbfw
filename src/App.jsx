...
const SplashScreen = ({ animState, styles = DEFAULT_STYLES, style }) => {
...
const Ic = ({n,s=22,c=C.dark,sw=2}) => {
  const p = {stroke:c,fill:"none",strokeWidth:sw,strokeLinecap:"round",strokeLinejoin:"round"};
  const m = {
...
const FEB21 = [
  {id:"h1", label:"+63908281107",           time:"11:30 PM", amount:2700,  positive:true,  sub:"Received money from"},
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{fontSize:23.5,fontWeight:800,marginBottom:7.5}}>+63 951 436 8494</div>
        ...
        <div style={{ display:"flex", flexDirection:"column", alignItems:"center", width: "100%" }}>
          <button style={{padding:"12px 24px",borderRadius:styles.loginScreenLockRadius,border:"none",background:"#f2f2f2",color:C.dark,fontSize:styles.loginScreenLockFontSize,fontWeight:800,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:8, marginBottom: 24}}>
          ...
          <div style={{fontSize:styles.loginSwitchAccountSize,color:C.med, marginBottom: isKeyboardOpen ? 0 : 24}}>Not you? <span style={{color:C.green,fontWeight:800,cursor:"pointer"}}>Switch account</span></div>
        </div>
...
const PBBScreen = ({balance,onBack,onVote,daysLeft,chancesLeft,maxChances,fastMode,styles=STYLES}) => {
  ...
  return (
    ...
    <div style={{ position: "relative", width: "100%", background: "#000", height: styles.pbbBannerHeight }}>
      ...
      {/* Tabs */}
      <div style={{display:"flex", borderBottom:`1px solid ${C.gray}`, padding: "0 20px", marginTop: 8}}>
        {["Save","Evict"].map((t,i)=>(
          <div key={t} style={{
            flex: 1,
            textAlign: "center",
...
const handleAddTxn=(tx)=>{
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", minHeight: "100vh", background: "#000" }}>
      ...
      <div style={{ width: "100%", maxWidth: 412, height: "100vh", background: C.white, overflow: "hidden", position: "relative", display: "flex", flexDirection: "column" }}>
        
        <div style={{flex:1, overflow:"hidden", position:"relative"}}>
          {/* SLIDER CONTAINER: Wraps Login and Splash for synchronized horizontal transition */}
          <div style={{
            display: 'flex',
            width: '200%',
            height: '100%',
